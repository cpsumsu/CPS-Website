...
export default function EventCard({event, tagColor}) {
  return (
    <div className='relative rounded-lg shadow-lg dark:shadow-md dark:shadow-slate-800 overflow-hidden'>
      ...
      <div className="px-6 py-4 space-y-1 bg-gray-100 dark:bg-cardDark">
        ...
        <p className="text-sm font-semibold text-neutral-400 dark:text-neutral-300">{event.leader}</p>
      </div>
    </div>
  )
}
