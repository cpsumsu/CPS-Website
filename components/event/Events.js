...
export default function Events() {
  const events = [
    ...
    { id: 2, name: "遊戲設計工作坊", leader: "Tom", date: new Date("2022-1-8"), type: "工作坊", imageUrl: "https://cpsumsu.org/static/image/event/3_game_design_workshop_2022.png" },
    { id: 3, name: "網絡安全-職業分享會", leader: "Kelvin", date: new Date("2022-1-8"), type: "工作坊", imageUrl: "https://cpsumsu.org/static/image/event/2_career_sharing_2021.png" },
    { id: 4, name: "英雄聯盟澳大杯", leader: "Wilson, Sunny,Ah Mo", date: new Date("2022-5-26"), type: "比賽", imageUrl: "https://cpsumsu.org/static/image/event/4_LOL_Cup_2022.png" },
  ];
